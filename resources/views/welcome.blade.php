...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .car .car-front:after, .car .car-front:before {
            content: "";
            width: 20px;
            height: 10px;
            ...
            .car .car-middle:before, .car .car-middle:after {
            content: "";
            display: block;
            ...
            .car .car-back:before, .car .car-back:after {
            content: "";
            width: 23px;
            height: 12px;
            ...
            *display: inline;
            ...
            .vacancy:before {
            content: "Espacio para parquear";
            }
            .vacancy:hover:before {
            content: "Oprime el boton start en la parte inferior.";
            }
            .vacancy + .car {
            margin-left: 40px;
            }
            ...
            *display: inline;
            ...
            input.passo1:checked ~ .breadcrumbs > .passo2-label, input.passo1:checked + input.passo2:checked ~ .breadcrumbs > .passo3-label, input.passo1:checked + input.passo2:checked + input.passo3:checked ~ .breadcrumbs > .passo4-label {
            pointer-events: all;
    ...
    <body >
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <header>
                <h1>
                    <span class="header-subtitile">BIENVENIDOS</span>
                ...
                <div class="car-line">
                    ...
                    <label class="passo1-label" for="passo1">Paso1</label><label class="passo2-label" for="passo2">Paso2</label><label class="passo3-label" for="passo3">Paso3</label><label class="passo4-label" for="passo4">Final</label>
                    </div>
                    <div class="congrats">
                    ...
                    <h3 class="congrats-subtitle">
                       Aqui podras encontras los mejores sitios de parqueaderos y su disponibilidad
                    </h3>
